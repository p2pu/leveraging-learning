...
<img src="https://raw.githubusercontent.com/lybram/lll-test/gh-pages/img/iceberg.png" alt="an iceberg modeling explicit knowledge (above water) and tacit knowledge (submerged)" width="300" align="left" hspace="5" vspace="5"> As the image of the iceberg conveys, a good deal of what we know is tacit rather than explicit knowledge – knowledge that is below the surface of our conscious awareness. When, for example, is the last time (outside of a yoga class) that you thought about how to breathe or how to balance on your feet? 
